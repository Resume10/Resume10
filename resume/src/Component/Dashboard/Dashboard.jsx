...
import { Edit, Plus, Award, Briefcase, FileText, Camera, Save, X, Mail, Phone, MapPin, User, ChevronRight, LogOut } from 'lucide-react';
import axios from 'axios';
import { Link, useNavigate } from 'react-router-dom';
// ANIMATION: Import motion and AnimatePresence
...
const Dashboard = () => {
  ...
  // ANIMATION: Variants for page load and form fields
  const pageVariants = {
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 pb-12">
      <div className="container mx-auto px-6 pt-10 relative z-10">
        <motion.div 
          ...
          // ANIMATION: Apply page load animation
          initial="hidden"
          animate="visible"
          variants={pageVariants}
        >
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
            {/* ANIMATION: Wrap the view toggle in AnimatePresence for smooth transitions */}
                  ...
                  <div className="md:w-1/3 bg-gradient-to-br from-blue-50 to-indigo-50 p-8 flex flex-col items-center justify-center border-r border-gray-100">
                    <div className="relative mb-4">
                      <div className="h-48 w-48 rounded-full overflow-hidden bg-gradient-to-r from-blue-600 to-indigo-600 p-1 shadow-lg">
                        <img 
                          src={userData.profilePicture || "/api/placeholder/300/300"}
                          alt="Profile"
                    ...
                    <motion.button 
                      ...
                      // ANIMATION: Add hover and tap effects
                    ...
                    <motion.button 
                      ...
                      className="mt-4 w-full bg-white border border-red-500 text-red-600 hover:bg-red-50 transition py-2 px-4 rounded-lg shadow-sm hover:shadow-md flex items-center justify-center"
                      // ANIMATION: Add hover and tap effects
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                    >
                  ...
                  <div className="flex flex-col">
                    <div className="flex justify-center mb-8">
                      <div className="relative">
                        <div className="h-48 w-48 rounded-full overflow-hidden bg-gradient-to-r from-blue-600 to-indigo-600 p-1 shadow-lg">
                          <img 
                            src={imagePreview || editFormData.profilePicture || "/api/placeholder/300/300"}
                            alt="Profile"
                    ...
                    {/* ANIMATION: Stagger form field animations */}
                    <motion.form 
                      className="space-y-6"
                      ...
                      animate="visible"
                    >
                      <motion.div variants={pageVariants} className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                      ...
                      <motion.div variants={pageVariants} className="pt-6">
                        <motion.button
                          type="button"
        ...
        <motion.div 
          ...
          // ANIMATION: Animate the button along with the card
          initial="hidden"
          animate="visible"
          variants={pageVariants}
          transition={{ delay: 0.2 }} // Slight delay to appear after the main card
        >
          <Link to="/NewResume">
            <motion.button 
              className="flex items-center border-1 border-indigo-600 bg-white text-indigo-600 hover:text-indigo-800 py-3 px-6 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 font-medium transform hover:-translate-y-1"
              // ANIMATION: Add hover and tap effects
